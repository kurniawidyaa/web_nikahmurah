...
class KategoriPostDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($row) {
                $action = '';
                if (Gate::allows('update blog/kategori_posts')) {
                ...
                if (Gate::allows('delete blog/kategori_posts')) {
     ...
     *
     * @param \App\Models\KategoriPostDataTable $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(KategoriPost $model)
    {
    ...
    public function html()
    {
        return $this->builder()
            ->searchDelay(1000)
            ->setTableId('kategoriPosts-table')
    ...
    {
        return 'KategoriPost_' . date('YmdHis');
    }
}
